  ...
  return (
    <div className="fixed inset-0 bg-black/90 flex items-center justify-center z-20">
      <div className="flex flex-col gap-4 p-8 rounded-2xl bg-black/50 border border-white/10 w-[500px] max-h-[80vh] overflow-y-auto">
        ...
        <h3 className="text-lg font-bold text-red-400 mt-2">Audio</h3>
        <Slider label="Master Volume" value={settings.masterVolume} onChange={settings.setMasterVolume} />
        <Slider label="Engine" value={settings.engineVolume} onChange={settings.setEngineVolume} />
        <Slider label="SFX" value={settings.sfxVolume} onChange={settings.setSfxVolume} />
